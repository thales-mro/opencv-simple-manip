...
\begin{document}
  ...
  For this exercise, the img-red from previous exercise (labed here image A), is manipulated with img-green from the same problem (labed here as B). The figure \ref{fig:o-3-0} represents image B, with the 100x100 central pixels from image A.  
  \begin{figure}[!h]
    \centering
